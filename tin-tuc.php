            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="card mb-4 reset"style="margin:30px 0 20px; text-align:justify">
                        <a href="chi-tiet-tin-tuc.php"><img class="card-img-top" style="width:100%" src="https://dummyimage.com/850x350/dee2e6/6c757d.jpg"/></a>
                        <div class="card-body reset" style="padding-top:15px;">
                            <a href="chi-tiet-tin-tuc.php"><h2 class="card-title">Featured Post Title</h2></a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="product-pagination text-center">
                                <nav>
                                <ul class="pagination">
                                    <li style="font-size:16px"><a href="#"><i class="fas fa-arrow-down"></i> Xem thêm</a></li>
