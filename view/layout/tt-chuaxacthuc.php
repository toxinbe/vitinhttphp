       ...
       <div class="product-big-title-area" style="margin-bottom:30px;">
          ...
          <div class="row">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="home">
                            <form action="../controller/xulythanhtoan.php" method="post">
                                ...
                                if(isset($_SESSION["hoTen"])){
                                    echo'<input class="form-input" type="text" name="hoVaTen" value="'.strip_tags($_SESSION["hoTen"]).'" placeholder="Họ và Tên (VD: Nguyễn Văn A)" required>';
                                }else{
                                ...
                                if(isset($_SESSION["soDienThoai"])){
                                    echo'<input class="form-input" type="text" id="txtSoDienThoai" name="soDienThoai" value="'.strip_tags($_SESSION["soDienThoai"]).'" placeholder="Số điện thoại (VD: 0901234567)" required>';
                                }else{
                                ...
                                if(isset($_SESSION["diaChi"])){
                                    echo'<input class="form-input" type="text" name="diaChi" value="'.strip_tags($_SESSION["diaChi"]).'" placeholder="Địa chỉ (VD: 180 Cao Lỗ, P4, Q8, Tp HCM)" required>';
                                }else{
                                    echo'<input class="form-input" type="text" name="diaChi" placeholder="Địa chỉ (VD: 180 Cao Lỗ, P4, Q8, Tp HCM)" required>';
                                } 
                                ?>                                              
                                <button id="btnSoDienThoai" value="xacThucThongTin" name="xacThucThongTin" class="form-input" type="submit">Xác Nhận</button>
            ...
            <div class="col-md-4" style="border: 1px solid #ccc;font-size:16px;">
                <?php include '../view/layout/table-giohang.php';?>
            </div>
            <div class="col-md-1"></div>
          </div>
        </div>