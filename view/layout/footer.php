 <div class="footer-top-area">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-about-us">                    
                        <h2><img src="../view/img/logo2.png"></h2>
    ...
    <!-- jQuery easing -->
    <script src="../view/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="../view/js/main.js"></script>
    <!-- Slider -->
    <script type="text/javascript" src="../view/js/bxslider.min.js"></script>
	  <script type="text/javascript" src="../view/js/script.slider.js"></script>
    <script>
      // **********************
$(function(){
...
// **********************
    ...
    <img src="../view/img/ve-chung-toi.png" style="display:none;">