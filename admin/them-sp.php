                          ...
                          <form>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="txtTenSanPham" id="feTenSP" placeholder="Tên sản phẩm">
                              </div>
                              <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                  ...
                                  <select name="cbxLoai" id="feLoai" class="form-control">
                                    <option value="0" selected>Chọn ...</option>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input name="numSoLuong" type="number" class="form-control" id="feSoLuong" placeholder="Cái">
                                </div>                              
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                  <label for="feHang">Hãng</label>
                                  <select name="cbxHang" id="feHang" class="form-control">
                                    <option value="0" selected>Chọn ...</option>
                              ...
                              <div class="form-group col-md-6">
                                    ...
                                    <input name="numGia" type="number" class="form-control" id="feGia" placeholder="đ">
                              </div>                           
                            </div>
                            ...
                            <div style="text-align:right;">
                              <button name="btnNhapLai" type="submit" class="btn btn-mb-2 btn btn-secondary mr-2 btn-font"><i class="fas fa-undo"></i> Nhập lại</button>
                              <button name="btnThem" type="submit" class="btn btn-mb-2 btn btn-success mr-2 btn-font" style="margin:0 !important;"><i class="fas fa-plus"></i> Thêm</button>
                            </div>                   
                          </form>
                        </div>
                      </div>
