                  ...
                  <div class="card-header border-bottom">
                    <div class="row">
                      ...
                      <div class="col-md-6" style="text-align:right">
                        <a href="them-bv.php" class="mb-2 btn btn-success mr-2 btn-font" style="margin:0 !important;"><i class="fas fa-plus"></i> Thêm</a>
                      </div>
                    </div>
                  </div>
                  <div class="table-sp">
                    ...
                    <table class="table mb-0">
                      ...
                      <tbody><?php
                        ...
                        for($i=0;$i<count($arrTacGia);$i++) {
                          echo '
                          <tr>
                          <td><img class="hinh-anh" src="../img/'.$arrTenHinh[$i].'.jpg"></td>
                          <td><a href="sua-bv.php">';
                          ...
                          if($soLuongKyTu>30){
                            ...
                            $arrTieuDe[$i]=substr($arrTieuDe[$i],0,33);
                          }
                          echo $tam.'</a></td>
                          <td>'.$arrChuDe[$i].'</td>
                          <td>'.$arrTacGia[$i].'</td>
