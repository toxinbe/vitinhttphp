                          ...
                          <form>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" id="feEmail" placeholder="Email"> </div>
                              <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" id="fePassword" placeholder="Mật khẩu">
                              </div>
                              <div class="form-group col-md-6">
                            ...
                            <div class="form-row mb-3">
                              <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" id="feRePassword" placeholder="Nhập lại mật khẩu">
                              </div>
                              <div class="form-group col-md-6">
                            ...
                            <div style="text-align:right;">
                              ...
                              <button type="submit" class="btn btn-mb-2 btn btn-success mr-2 btn-font" style="margin:0 !important;"><i class="fas fa-user-plus"></i> Thêm</button>
                            </div>                   
                          </form>
                        </div>
                      </div>
