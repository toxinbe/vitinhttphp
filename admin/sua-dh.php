                        ...
                        <div class="col-8">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="feNgayTaoDon" value="2021-11-08">
                              </div>
                              <div class="form-group col-md-6">
                        ...
                        <div class="col-4">
                          <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <textarea style="padding-top:9.5px;padding-bottom:9.5px;" class="form-control" name="feGhiChu" rows="5" placeholder="Ghi chú...">khách chỉ nhận hàng trong giờ hành chính</textarea>
                              </div>
                          </div>
                          <div class="form-row" >
                            <div class="form-group col-md-12">
