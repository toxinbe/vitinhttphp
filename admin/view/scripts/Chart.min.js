                ...
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function(n, i) {
                        ...
                        var l = r.acquireContext(n, i),
                            ...
                            u = s && s.height,
                            d = s && s.width;
                        o.id = a.uid(), o.ctx = l, o.canvas = s, o.config = i, o.width = d, o.height = u, o.aspectRatio = u ? d / u : null, o.options = i.options, o._bufferedRender = !1, o.chart = o, o.controller = o, t.instances[o.id] = o, Object.defineProperty(o, "data", { get: function() { return o.config.data }, set: function(t) { o.config.data = t } }), l && s ? (o.initialize(), o.update()) : console.log("Failed to create chart: can't acquire context from the given item")
                    },
