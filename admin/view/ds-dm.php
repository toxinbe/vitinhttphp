                                ...
                                <div class="card-header border-bottom">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" style="text-align:right">
                                            <a href="" class="mb-2 btn btn-success mr-2 btn-font"
                                        ...
                                        <table class="table mb-0">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="border-0" colspan="10"
                                                        style="text-align:left">Tên danh mục</th>
                                                    <th scope="col" class="border-0"
                                                        style="text-align:right;padding-right: 70px!important">Tùy chỉnh
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="width:11%;"><button type="button"
                                                            class="mb-2 btn btn-sm btn-outline-light mr-1">0</button>
                                                    </td>
                                                    <td colspan="10" style="text-align:left">PC</td>
                                                    <td style="text-align:right">
                                                        <a href="" class="mb-2 btn btn-success mr-2 btn-font"><i
                                                                class="fas fa-plus"></i> Thêm cấp con</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:11%;"><button type="button"
                                                            class="mb-2 btn btn-sm btn-outline-light mr-1">1</button>
                                                    </td>
