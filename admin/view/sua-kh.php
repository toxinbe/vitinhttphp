                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="email" class="form-control" id="feEmail"
                                                            placeholder="Email" value="test@123">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="password" class="form-control" id="fePassword"
                                                            placeholder="Mật khẩu" value="t&tcomputer">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row mb-3">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="password" class="form-control" id="feRePassword"
                                                            placeholder="Nhập lại mật khẩu" value="t&tcomputer">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div style="text-align:right;">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        style="margin:0 !important;"><i class="fas fa-user-edit"></i>
                                                        Sửa</button>
                                                </div>
                                            </form>
                                        </div>
