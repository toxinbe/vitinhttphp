                  ...
                  <div class="card-header border-bottom">
                    <div class="row">
                      ...
                      <div class="col-md-6" style="text-align:right">
                        <a href="ds-bv.php" class="mb-2 btn btn-primary mr-2 btn-font" style="margin:0 !important;"><i class="fas fa-arrow-left"></i> Trở về</a>
                      </div>
                    </div>
                  </div>
                          ...
                          <form>
                            <div class="form-row">
                              <div class="card-body" style="padding-left:5px;padding-right:5px;">
                                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Tiêu đề bài viết" value="Tuyển nhân viên giữ xe lương cao bằng sếp">
                                      <div id="editor-container" style="height:auto;" class="add-new-post__editor mb-1"></div>
                              </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row mb-3">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="feTenTacGia" placeholder="Tên tác giả" value="Admin">
                              </div>
                              <div class="form-group col-md-6">
