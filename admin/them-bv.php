                          ...
                          <form>
                            <div class="form-row">
                              <div class="card-body" style="padding-left:5px;padding-right:5px;">
                                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Tiêu đề bài viết">
                            ...
                            <div class="form-row mb-3">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="feTenTacGia" placeholder="Tên tác giả">
                              </div>
                              <div class="form-group col-md-6">
