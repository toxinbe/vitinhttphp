                          ...
                          <table class="table mb-0">
                            <thead class="bg-light">
                              <tr>
                                ...
                                <th scope="col" class="border-0 none">Hãng</th>
                            ...
                            <tbody><?php
                              ...
                              for($i=0;$i<count($arrMaSP);$i++) {
                                ...
                                <td>'.$arrTenSP[$i].'</td>
                                <td>'.$arrLoai[$i].'</td>
                                <td class="none">'.$arrHang[$i].'</td>                          
                                <td class="none">'.$arrBaoHanh[$i].' tháng</td>                          
                                <td>'.$arrSoLuong[$i].'</td>                          
                                <td>'.number_format($arrGia[$i],0,",",".").'</td>                          
                                <td>
                                <a href="sua-sp.php" class="mb-2 btn btn-info mr-2 btn-font">
