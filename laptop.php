        ...
        <div class="container">
            <div class="row">
                ...
                for($i=0;$i<12;$i++){
                    ...
                    echo '          <a href="chi-tiet-san-pham1.php"><img src="img/laptop-2.jpg" alt=""></a>';
                    echo '      </div>';
                    echo '      <h2><a href="chi-tiet-san-pham1.php">Laptop lập trình</a></h2>';
                    echo '      <div class="product-carousel-price">';
                    echo '          <ins>9.999.999đ</ins> <del>12.499.999đ</del>';
                    echo '      </div>  ';
